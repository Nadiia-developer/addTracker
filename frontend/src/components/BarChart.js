...
//                 type: 'bar',
//                 data: {
//                     labels: data.map(campaign => campaign.name),
//                     datasets: [
//                         {
//                             label: 'Campaigns',
//                             data: data.map(campaign => campaign.goal.length),
//                         },
//                     ],
//                 },
//                 options: {},
...
//
//     useEffect(() => {
//         if (data.campaigns.length > 0 || data.offers.length > 0) {
//             const myChartRef = chartRef.current.getContext('2d');
//
//             if (chartInstance) {
//                 chartInstance.destroy();
//             }
//
//             const campaignNames = data.campaigns.map(campaign => campaign.name);
//             const campaignOfferCounts = data.campaigns.map(campaign =>
...
//             );
//
//             const campaignClickCounts = data.campaigns.map(campaign => {
...
//             });
//
//             const campaignLeadCounts = data.campaigns.map(campaign => {
//             const campaignOfferIds = data.offers.filter(offer => offer.campaign === campaign.id).map(offer => offer.id);
